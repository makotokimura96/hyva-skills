---
name: hyva-theme
description: Use when working on the Hyvä theme layer of a Magento 2 storefront: installing or upgrading Hyvä, creating or debugging a child theme, running or fixing the Tailwind build, writing a .phtml template or a view model, adding SVG icons, modals, sliders or form validation, wiring customer section data or fetch() calls, styling CMS or Page Builder content, writing a *-hyva-compat module or porting Luma LESS/RequireJS/Knockout markup to Tailwind, configuring static content deploy, or diagnosing an unstyled storefront, purged Tailwind classes, stale DI config or Varnish/ESI staleness. Also storefront strict CSP setup and version requirements. Theme scope only - use hyva-checkout for checkout steps and Magewire, alpinejs-csp for authoring Alpine components, hyva-commerce for Hyvä CMS, hyva-admin for admin grids. Keywords hyva/default, hyva_default handles, tailwind-source.css, hyva-themes.json, ViewModelRegistry, heroicons, window.hyva, magento2-default-theme.
---
