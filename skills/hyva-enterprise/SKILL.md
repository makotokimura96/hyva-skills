...
description: Wires Adobe Commerce enterprise features onto a Hyvä storefront through the separately licensed Hyvä Enterprise compatibility modules. Use when installing or upgrading a hyva-themes/magento2-hyva-enterprise-* metapackage, wiring B2B into Hyvä Checkout (company accounts, negotiable quotes, requisition lists, purchase orders, company credit), enabling Commerce-only features on the storefront (gift card, gift wrapping, reward points, RMA, customer balance, multiple wishlist), debugging the Google Tag Manager dataLayer or Data Services / Data Connection event tracking, styling or disabling the Live Search React PLP Widget, integrating Product Recommendations or Edge Delivery Services, customising a Hyva_Magento* module, or answering whether Hyvä supports a given Adobe Commerce feature and which license it needs. Keywords Hyvä Enterprise, Hyva_EnterpriseCheckoutB2b, magento/extension-b2b, live-search, product-recommendations, data-connection, experience-connector, EDS.
---
