...
description: Supplies ready-made storefront UI for Hyvä from two add-ons: the separately licensed Hyvä UI Library (hyva-themes/hyva-ui) of copy-paste .phtml components with PHP and Alpine logic already wired - headers, mega and mobile menus, product galleries, sliders, minicart, ajax add-to-cart, category filters, cookie notices - and the free Hyvä Widgets module (hyva-themes/magento2-hyva-widgets) of native admin-editable Magento 2 widgets for banners, content and category product sliders. Use when installing or licensing hyva-ui or Hyva_Widgets, copying a component into a child theme instead of hand-building a header, menu, slider or gallery, configuring gallery options in etc/view.xml, building a scroll-snap slider or using x-snap-slider, reading component badges or the Figma design system, translating copied components, giving a client an editable CMS block without PageBuilder, or choosing between Hyvä UI, Hyvä Widgets, PageBuilder and Hyvä CMS.
---
